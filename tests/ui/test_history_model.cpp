...
private slots:
    void empty_model_has_zero_rows()
    {
        ...
        QCOMPARE(m.columnCount(), static_cast<int>(gittide::ui::HistoryModel::ColCount));
    }
    ...
    {
        gittide::ui::HistoryModel m;
        QCOMPARE(m.headerData(gittide::ui::HistoryModel::ColSummary, Qt::Horizontal, Qt::DisplayRole).toString(),
